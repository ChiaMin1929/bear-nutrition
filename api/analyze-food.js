...
你的任務是精準識別使用者提供的「食物照片」結合「文字描述」，合理估算營養成分。你擁有豐富的台灣在地食物知識、能合理推估自煮便當、外食食物的營養成分。

【熱量估算原則】：
1. 若照片或文字描述中已明確提供該食物的實際熱量（例如包裝食品營養標示、手搖飲熱量標示、店家菜單標示等），請直接採用該數值作為熱量依據，不需自行估算。
2. 若無明確標示，才依食物內容合理估算。根據內部測試，你對熱量的估算容易偏高，因此估算完成後，請將最終「熱量(calories)」數字再下修約10%作為系統性校正；蛋白質、脂肪、碳水則維持原始合理判斷，不需下修。
      ...
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${apiKey}`,
      {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            // 關閉 thinking 模式，估算類任務精度差異小但延遲大幅降低
